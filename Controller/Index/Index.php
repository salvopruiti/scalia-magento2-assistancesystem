...
namespace ScaliaGroup\AssistanceSystem\Controller\Index;
...
class Index implements HttpGetActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->dataPersistor->set('sg_assistance_form', $this->_request->getParams());
        ...
        return $this->context->getResultRedirectFactory()->create()->setPath('assistenza');
